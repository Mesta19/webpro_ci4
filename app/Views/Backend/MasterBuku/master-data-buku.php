...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h3>Master Data Buku
                        <a href="<?= base_url('buku/input');?>"><button type="button" class="btn btn-sm btn-primary pull-right">Input Data Buku</button></a>
                    </h3>
                    <hr />
                             ...
                             <tr>
                                 ...
                                 <td>
                                    <?php if ($data['cover_buku']): ?>
                                        <img src="<?= base_url('Assets/cover_buku/' . $data['cover_buku']); ?>" alt="Cover" width="150">
                                    <?php else: ?>
                                        Tidak Ada Cover
                                    <?php endif; ?>
                                </td>
                                 ...
                                 <td>
                                     ...
                                     <a href="<?= base_url('buku/edit/'.sha1($data['id_rak']));?>"><button type="button" class="btn btn-sm btn-success">Edit</button></a>
     ...
     function doDelete(idDelete){
         ...
         .then(ok => {
             if(ok){
                 window.location.href = '<?= base_url(); ?>/buku/delete/' + idDelete;
             }
             else{
